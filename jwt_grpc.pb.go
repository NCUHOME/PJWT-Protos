...
func (c *passportClient) ParseJwt(ctx context.Context, in *RequestParseJwt, opts ...grpc.CallOption) (*ParseJwtResult, error) {
	...
	err := c.cc.Invoke(ctx, Passport_ParseJwt_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *passportClient) GenToken(ctx context.Context, in *RequestGenToken, opts ...grpc.CallOption) (*GenTokenResult, error) {
	...
	err := c.cc.Invoke(ctx, Passport_GenToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPassportServer) ParseJwt(context.Context, *RequestParseJwt) (*ParseJwtResult, error) {
	return nil, status.Error(codes.Unimplemented, "method ParseJwt not implemented")
}
